    ...
    <style>
        * {
        ...
        .login-particles {
            ...
            height: 100%;
            background-image: 
                radial-gradient(2px 2px at 20px 30px, #eab308, rgba(234, 179, 8, 0)),
                radial-gradient(2px 2px at 60px 70px, #d4af37, rgba(212, 175, 55, 0)),
                radial-gradient(1px 1px at 50px 50px, #FACC15, rgba(250, 204, 21, 0)),
                radial-gradient(1px 1px at 130px 80px, #a78bfa, rgba(167, 139, 250, 0)),
                radial-gradient(2px 2px at 90px 10px, #d4af37, rgba(212, 175, 55, 0));
...
<body class="login-body">
    ...
    <div class="login-container">
        ...
        <div class="login-left-panel">
            <div class="login-left-content">
                ...
                <p class="login-left-description">
                    A warm, organized, and prayerful space to serve your congregation with excellence.
                </p>
        ...
        <div class="login-right-panel">
            <div class="login-glass-card">
                ...
                <?php if ($error): ?>
                    <div class="login-error-message" id="errorMsg">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Add animation stagger to form fields
